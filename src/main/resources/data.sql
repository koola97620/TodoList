...
(1,'스프링 책 읽기',3 , 'todoadmin@gmail.com' , 1 , '2019-03-07 00:00:01','2019-03-31 00:00:01',false,1);
INSERT INTO task(id,title,priority,user,board,start_date,expire_date,completed,task_content_id) VALUES
(2,'산책하기', 2 , 'todoadmin@gmail.com' , 1 , '2019-03-08 00:00:01', null , true,2);
INSERT INTO task(id,title,priority,user,board,start_date,expire_date,completed,task_content_id) VALUES
(3,'운동하기', 1 , 'todoadmin@gmail.com' , 1 , '2019-03-21 00:00:01', null , false,3);
INSERT INTO task(id,title,priority,user,board,start_date,expire_date,completed,task_content_id) VALUES
(4,'스터디 가기', 5 , 'todoadmin@gmail.com' , 1 , '2019-03-22 14:00:01', '2019-03-22 20:00:01' , false,4);
INSERT INTO task(id,title,priority,user,board,start_date,expire_date,completed,task_content_id) VALUES
(5,'영화 표 예매하기', 4 , 'todoadmin@gmail.com' , 1 , '2019-03-25 09:00:01', '2019-03-25 09:30:00' , false,5);
INSERT INTO task(id,title,priority,user,board,start_date,expire_date,completed,task_content_id) VALUES
(12,'영화 표 예매하기2', 7 , 'todoadmin@gmail.com' , 7 , '2019-03-28 09:00:01', '2019-03-28 09:30:00' , false,5);
INSERT INTO task(id,title,priority,user,board,start_date,expire_date,completed,task_content_id) VALUES
(13,'영화 표 예매하기3', 6 , 'todoadmin@gmail.com' , 7 , '2019-03-29 09:00:01', '2019-03-29 09:30:00' , false,5);
